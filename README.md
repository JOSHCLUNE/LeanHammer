...
***Note:** Although the LeanHammer repository has been updated to support `v4.29.0`, the LeanPremise server which LeanHammer uses for premise selection is still being updated from `v4.28.0` to `v4.29.0`. During the intermediate period while this update is occurring, premise selection may be slower and less accurate than usual. This note will be removed once the server has been fully updated to `v4.29.0`.*
